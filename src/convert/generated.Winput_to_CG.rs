...
pub fn vk_to_cgkeycode(value: Vk) -> Option<CGKeyCode> {
  let result = match value {
    ...
    Vk::LeftMenu     => CGKeyCode( KeyCode::OPTION                     ),
    ...
    Vk::LeftWin      => CGKeyCode( KeyCode::COMMAND                    ),
